...
- **PromptBridge: Convert Arabic Selection with Mode...**
  Opens a mode picker before conversion. Use it when you want this selected prompt converted as `fix`, `refactor`, `review`, `tests`, `explain`, `security`, `general`, or `auto`.
